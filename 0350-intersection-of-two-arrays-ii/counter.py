...
def intersect(nums1, nums2):
    ...
    # чтобы потенциально ускорить процесс, если один массив значительно меньше другого
    ...
    for num, count1 in counts1.items():
        if num in counts2:
            # Добавляем элемент минимальное количество раз, которое он встречается в обоих массивах
